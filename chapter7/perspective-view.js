...
function initVertexBuffer(gl) {
    const vertices = new Float32Array([
        ...
        0.75, 1.0, -10.0, 1.0, 1.0, 0.4, // The yellow triangle in middle
        0.25, -1.0, -10.0, 1.0, 1.0, 0.4,
        1.25, -1.0, -10.0, 1.0, 0.4, 0.4,

        0.75, 1.0, -8.0, 0.4, 0.4, 1.0, // The blue triangle in front
        0.25, -1.0, -8.0, 0.4, 0.4, 1.0,
        1.25, -1.0, -8.0, 1.0, 0.4, 0.4,

        0.75, 1.0, -6.0, 0.4, 1.0, 0.4, // The green triangle in back
        0.25, -1.0, -6.0, 0.4, 1.0, 0.4,
        1.25, -1.0, -6.0, 1.0, 0.4, 0.4,
        ...
        -0.75, 1.0, -10.0, 1.0, 1.0, 0.4, // The yellow triangle in middle
        -1.25, -1.0, -10.0, 1.0, 1.0, 0.4,
        -0.25, -1.0, -10.0, 1.0, 0.4, 0.4,

        -0.75, 1.0, -8.0, 0.4, 0.4, 1.0, // The blue triangle in front
        -1.25, -1.0, -8.0, 0.4, 0.4, 1.0,
        -0.25, -1.0, -8.0, 1.0, 0.4, 0.4,
